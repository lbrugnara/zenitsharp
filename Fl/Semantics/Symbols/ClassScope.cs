...
namespace Fl.Semantics.Symbols
{
    public class ClassScope : Scope
    {
        ...
        public Symbol CreateProperty(string name, Type type, Access access, Storage storage)
        {
        ...
        public Symbol CreateConstant(string name, Type type, Access access)
        {
        ...
        public Symbol CreateMethod(string name, Type type, Access access)
        {
            var symbol = this.CreateSymbol(name, type, access, Storage.Constant);
