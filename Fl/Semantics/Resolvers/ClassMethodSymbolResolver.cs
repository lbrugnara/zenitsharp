...
{
    class ClassMethodSymbolResolver : INodeVisitor<SymbolResolverVisitor, ClassMethodNode, ISymbol>
    {
        public ISymbol Visit(SymbolResolverVisitor visitor, ClassMethodNode method)
        {
